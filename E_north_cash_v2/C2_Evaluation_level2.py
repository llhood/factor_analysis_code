...
name = "北向资金II级"
df_PE = pd.read_csv("Factor/B2_Mthly_lgtrationsum_level2.csv", encoding="gbk")
...
df_score_group1 = yearly_eval_group1(date_list,
                    ...
                    df_PE.iloc[:,1:].to_numpy(), split_num, freq)

name_list = df_PE.columns[1:]
df_hist_posi = historical_position(df_PE.iloc[:,1:].to_numpy(), name_list, split_num, date_list)
